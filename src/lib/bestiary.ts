...
export const bestiary: Creature[] = [
  ...
  },
  {
    ...
    omen: "見則其國大旱 and 見則天下大旱 — that state goes dry, or the world does",
  ...
  },
  {
    ...
    kind: "神",
    form: "human-faced, snake-bodied, red, a thousand 里 long; its eyes open are day and closed are night, its 吹 is winter and its 呼 is summer",
